...
(function() {
  ...
  var defaultKeymap = [
    ...
    { keys: ['Ctrl-w', 'v'], type: 'action', action: 'split',
        actionArgs: {type: 'HORIZONTAL'} },
    { keys: ['Ctrl-w', 's'], type: 'action', action: 'split',
        actionArgs: {type: 'VERTICAL'} },
  ...
  var Vim = function() {
    ...
    var actions = {
      ...
      split: function(cm, actionArgs) {
        CodeMirror.signal(cm, "split", actionArgs.type);
        console.log("split ");
